...
?>
  ...
  <li class="parent "><a data-toggle="collapse" href="#sub-item-2">
            ...
            <li class="parent "><a data-toggle="collapse" href="#sub-item-3">
                <em class="fa fa-gear">&nbsp;</em>Settings <span data-toggle="collapse" href="#sub-item-3" class="icon pull-right"><em class="fa fa-plus"></em></span>
                </a>
                <ul class="children collapse" id="sub-item-3">
                    <li><a class="" href="show-categories.php">
                        <span class="fa fa-arrow-right">&nbsp;</span> Categories
                    </a></li>
                    <li><a class="" href="add-limit.php">
                        <span class="fa fa-arrow-right">&nbsp;</span> Add Limit
                    </a></li> </li>
                    </ul>
